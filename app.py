...
if pl>0:
    pl_html = '<p style="text-align:right;color:DarkGreen;font-size:115%;border:2px solid Black;"><b>'+f"{pl:,.2f}"+'</b></p>'
elif pl<0:
    pl_html = '<p style="text-align:right;color:DarkRed;font-size:115%;border:2px solid Black;"><b>'+f"{pl:,.2f}"+'</b></p>'
else:
