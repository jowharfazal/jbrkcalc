...
if pl>0:
    pl_html = '<p style="text-align:right;color:LightGreen;font-size:115%;"><b>'+f"{pl:,.2f}"+'</b></p>'
elif pl<0:
    pl_html = '<p style="text-align:right;color:DarkRed;font-size:115%;"><b>'+f"{pl:,.2f}"+'</b></p>'
else:
